...
class Stats(commands.Cog):
    ...
    async def stats(self, ctx):
        ...
        bot_memory_usage = round(psutil.Process(os.getpid()).memory_info().rss / 1024**2) 
        ...
        embed.add_field(name='Memory Usage:', value=f'{bot_memory_usage} Mb', inline=True)
        embed.add_field(
        ...
        embed3.set_footer(icon_url=ctx.author.avatar_url, text=f'Information Requested By {ctx.author.display_name}')
